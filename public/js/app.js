...
// document.getElementById('player'); sin jquery
...
function crearMensajeHTML(mensaje, personaje, lat, lng, foto) {
    ...
    var content = `
    <li class="animated fadeIn fast d-flex justify-content-center mx-auto"
        data-tipo="mensaje">


        <div class="carreras">
            <img class="img-fluid rounded-circle w-25" src="img/carreras/${personaje}.png">
        </div>
...
function crearMensajeMapa(lat, lng, personaje,) {
    ...
    <li class="animated fadeIn fast"
        ...
        data-lng="${lng}">
                <div class="avatar">
                    <img class="img-fluid" src="img/carreras/${personaje}.png">
                </div>
                <div class="bubble-container">
                    <div class="bubble">
                        <iframe
...
function logIn(ingreso) {
    ...
    if (ingreso) {
        ...
        modalAvatar.attr('src', 'img/carreras/' + usuario + '.png');
    } else {
...
function enviarNotificacion() {
    ...
    const n = new Notification('Registrate', notificationOpts);
...
function notificarme() {
    ...
    if (Notification.permission === 'granted') {
        ...
        // new Notification('Bienvenido has tu registro! - granted');
        enviarNotificacion();
        ...
        Notification.requestPermission(function (permission) {
            ...
            if (permission === 'granted') {
                // new Notification('Bienvenido has tu registro! - pregunta');
                enviarNotificacion();
            }
        });
    }
